...
namespace FunkySheep.Osm.Systems
{
    [UpdateInGroup(typeof(OsmGroup))]
    public partial class ConvertNodeGpsCoordinatesToWorldCoordinates : SystemBase
    {
        protected override void OnUpdate()
        {
            ...
            Entities.ForEach((Entity entity, EntityCommandBuffer buffer, in DynamicBuffer<GPSCoordinates> gPSCoordinates) =>
            {
